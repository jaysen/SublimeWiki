    ...
    def run(self, edit):        
        ...
        if "link.external.Wikidpad" in self.view.scope_name(location.a):
            ...
            if os.path.exists(new_file):
                ...
                new_view.set_syntax_file("Packages/Wikidpad/Wikidpad.tmLanguage")
        else:
